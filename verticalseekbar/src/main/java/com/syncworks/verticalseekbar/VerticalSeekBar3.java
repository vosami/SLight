 ...
 */
public class VerticalSeekBar3 extends AbsVerticalSeekBar {
    ...
    public interface OnSeekBarChangeListener {
         ...
         */
        void onProgressChanged(VerticalSeekBar3 seekBar, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(VerticalSeekBar3 seekBar);
         ...
         * @param seekBar The SeekBar in which the touch gesture began
         */
        void onStopTrackingTouch(VerticalSeekBar3 seekBar);
    }
